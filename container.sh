...
docker run -dt --privileged=true -p 5001:22 -v /sys/fs/cgroup:/sys/fs/cgroup:ro --name "$DOCKER_CONTAINER_NAME1" -e AUTHORIZED_KEYS="$SSH_PUBLIC_KEY" centos8-systemd:latest
